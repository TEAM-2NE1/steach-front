...
import RealQuizListDrawer from "../../components/quiz/RealQuizListDrawer.tsx";
    ...
    >
      <div
        className={`${
          isFullscreen
            ...
            : "grid grid-cols-12 gap-4 w-full h-screen"
        } ${
      ...
      <div
        className={`grid grid-cols-12 gap-4 w-full mt-4 ${
          isChatOpen || isItemsOpen ? "mr-[320px]" : "mr-0"
      ...
      >
        ...
        <button
          ...
          className="mt-2 p-2 bg-discordChatBg text-discordText rounded w-full border-2 border-discordChatBg2"
        >
          전송
        </button>
      </div>
