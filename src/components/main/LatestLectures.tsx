...
import { CurriculasState, getLastestLecturelist } from "../../store/CurriculaSlice.tsx";
...
const LatestLectures: React.FC = () => {
  ...
  const curricula = useSelector(
    (state: RootState) => (state.curriculum as CurriculasState).returnLastestCurriculaList?.curricula
  );
